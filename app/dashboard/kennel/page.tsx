...
export const metadata: Metadata = {
  title: "犬舍管理",
  description: "Kennels dashboard page",
}

export default async function KennelListPage() {
      ...
      <div className="hidden h-full flex-1 flex-col space-y-8 p-8 md:flex w-full">
        <div className="flex items-center justify-between space-y-2">
          <div className="flex justify-end space-x-2">
            <h2 className="text-2xl font-semibold tracking-tight">犬舍管理</h2>
            <TooltipProvider>
              <Tooltip>
        ...
        <DataTable data={kennels} columns={columns} />
      </div>
    </>
  )
}
