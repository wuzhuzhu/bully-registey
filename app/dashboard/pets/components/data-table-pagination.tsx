      ...
      <div className="flex items-center space-x-6 lg:space-x-8">
        ...
        <div className="flex items-center space-x-2">
          <Button
            ...
            onClick={() => table.setPageIndex(0)} // client component
          ...
          <Button
            ...
            onClick={() => table.previousPage()} // client component
            disabled={!table.getCanPreviousPage()}
          >
          ...
          <Button
            variant="outline"
            className="h-8 w-8 p-0"
            onClick={() => table.nextPage()} // client component
          ...
          <Button
            variant="outline"
            className="hidden h-8 w-8 p-0 lg:flex"
            onClick={() => table.setPageIndex(table.getPageCount() - 1)} // client component
            disabled={!table.getCanNextPage()}
          >
