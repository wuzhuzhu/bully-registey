...
export const PetScalarFieldEnumSchema = z.enum(['id','name','nameEn','ownerName','ownerMobile','type','gender','birthDate','breed','color','location','createdAt','updatedAt','createdById','kennelId']);
